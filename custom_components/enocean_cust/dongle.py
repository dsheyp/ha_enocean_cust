...
class EnoceanCustDongle:
    """Representation of an Enocean Cust dongle.
    ...
    def __init__(self, hass, serial_path):
        """Initialize the Enocean Cust dongle."""
    ...
    def _send_message_callback(self, command):
        """Send a command through the Enocean Cust dongle."""
        self._communicator.send(command)

    def callback(self, packet):
        """Handle Enocean Cust device's callback.
