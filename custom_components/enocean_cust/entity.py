"""Representation of an Enocean Cust device."""
...
class EnoceanCustEntity(Entity):
    """Parent class for all entities associated with the Enocean Cust component."""
    ...
    def send_command(self, data, optional, packet_type):
        """Send a command via the Enocean Cust dongle."""
