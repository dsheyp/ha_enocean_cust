"""Config flows for the Enocean Cust integration."""
...
class EnoceanCustFlowHandler(ConfigFlow, domain=DOMAIN):
    """Handle the Enocean Cust config flows."""

    VERSION = 1
    MANUAL_PATH_VALUE = "Custom path"

    def __init__(self) -> None:
        """Initialize the Enocean Cust config flow."""
    ...
    async def async_step_user(
        ...
        """Handle an Enocean Cust config flow start."""
    ...
    def create_enocean_entry(self, user_input):
        ...
        return self.async_create_entry(title="Enocean Cust", data=user_input)
