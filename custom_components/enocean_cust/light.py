...
DEFAULT_NAME = "Enocean Cust Light"
...
def setup_platform(
    ...
    """Set up the Enocean Cust light platform."""
    sender_id: list[int] = config[CONF_SENDER_ID]
    dev_name: str = config[CONF_NAME]
    dev_id: list[int] = config[CONF_ID]

    add_entities([EnoceanCustLight(sender_id, dev_id, dev_name)])


class EnoceanCustLight(EnoceanCustEntity, LightEntity):
    """Representation of an Enocean Cust light source."""
    ...
    def __init__(self, sender_id: list[int], dev_id: list[int], dev_name: str) -> None:
        """Initialize the Enocean Cust light source."""
